                    ...
                    <div className="flex flex-col items-center justify-center py-14 px-6">
                        ...
                        <AnimatedContent>
                            ...
                            >
                                ...
                                <div className="mt-10 mb-2 grid w-full grid-cols-3 gap-6">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center rounded-full border border-gray-200 py-2.5 hover:bg-gray-50 focus:border-gray-300 cursor-pointer ${
                                            loadingProvider === 'google' ? 'opacity-75 cursor-not-allowed' : ''
                                        }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center rounded-full border border-gray-200 py-2.5 hover:bg-gray-50 focus:border-gray-300 cursor-pointer ${
                                            loadingProvider === 'github' ? 'opacity-75 cursor-not-allowed' : ''
                                        }`}
                                    >
                                ...
                                <button
                                    type="submit"
                                    className="mt-8 w-full h-11 bg-gradient-to-tr from-orange-600 to-orange-500 text-white rounded-full"
                                >
                                    Login
                                </button>
