...
export default function AnalyticsPage() {
    ...
    return (
        <div className="flex flex-col gap-8 h-[calc(100vh-6rem)] overflow-hidden">
            {/* Header */}
            <div>
            ...
            <VerificationGuard
                ...
                description="You are not a verified user. To access premium data features like Analytics, please verify your email first."
            >
                <div className="h-full overflow-y-auto overflow-x-hidden pr-2 custom-scrollbar pb-10">
